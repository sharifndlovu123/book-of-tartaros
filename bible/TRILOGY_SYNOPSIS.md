...
Across three generations, two powers prepare for a war each believes the other
...
## Book One — *The Warden of Tartaros* (complete) · theme: complicity

Bastien Orrel runs the Cleanse, believing he authored it; in truth the Architect,
**Xerxes**, did, and Bastien is his most successful product. **Kester Vaile**, a
logistics officer, defects after exposing the abuses of Wing Seven and becomes
the conscience of a small resistance — **Sable Reyek's** Undersiders. The
children die: **Aleya** poisoned in **Tev's** arms; **Pell** sacrificed early.
A civilian shuttle carrying **Yenna**, **Chayne**, and the four-year-old **Pira**
— and the digital archive of the Cleanse — is ordered destroyed. The Keris
secretly pull it to **Korya**. Yenna and Chayne die sealing Pira and the archive
in a protective vault; Pira survives. The Compact believes everything destroyed.

> **LOCKED.** The children's deaths (Aleya, Tev, Pell). Pira survives and reaches
> Korya with the archive. The Compact believes the shuttle destroyed. Kester
> carries the secret that Pira is (as far as he knows) dead. Book one ends with
...
theory), **Veliya's** accumulated knowledge, the dissenter **Tancred Caradec's**
brother case, **Cassian's** leak (the procurement records), **Cyrus's** protocols,
and the protagonists' archive. Six of eight active seats issue a **binding
pronouncement**. The Vendine fractures.

> **LOCKED — the ending, in pieces.**
> - **Quintus Aemilius ends his own life** in the Vendine tradition as the cascade exposes his accommodation.
> - **Marcus does NOT emerge** from his colosseum — no late tilt; the friendship with Bastien dies through drift, as it lived.
> - **Octavia disappears** — operator self-preservation, not moral refusal; she is never caught.
...
## The load-bearing ironies — never alter

These are the beams the whole structure rests on. If new work contradicts one,
stop and flag it.

1. The Cleanse is built partly in response to Xerxes's wife and child dying of the **black death** — which the **Keris engineered** and withhold the cure for. Xerxes does not know this.
...
*Companion files: `TARTAROS_CYCLE_BIBLE.md` (full canon), `TARTAROS_QUESTIONS.md`
(character tracker — now closed), `../reference/CHARACTER_MAP.md` (who's who and
the family trees).*
